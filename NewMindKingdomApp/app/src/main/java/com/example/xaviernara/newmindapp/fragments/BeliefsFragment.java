...
public class BeliefsFragment extends Fragment {

    private FragmentBeliefsBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentBeliefsBinding.inflate(inflater,container,false);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        binding.beliefs.setText(Html.fromHtml(htmlText1,Html.FROM_HTML_MODE_COMPACT));
        
        binding.vision.setText(Html.fromHtml(htmlText2,Html.FROM_HTML_MODE_COMPACT));

        binding.mission.setText(Html.fromHtml(htmlText3,Html.FROM_HTML_MODE_COMPACT));
    }
}
